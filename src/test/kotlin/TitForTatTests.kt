...
//        val scoreboard = com.mattbobambrose.prisoner.game_server.Scoreboard(listOf(titForTat, alwaysDefect))
//        val match = com.mattbobambrose.prisoner.game_server.Match(titForTat, alwaysDefect, scoreboard, rules)
//        match.runMatch()
...
//        val scoreboard = com.mattbobambrose.prisoner.game_server.Scoreboard(listOf(titForTat, defEveryThree))
//        val match = com.mattbobambrose.prisoner.game_server.Match(titForTat, defEveryThree, scoreboard, rules)
//        match.runMatch()
...
//        val scoreboard = com.mattbobambrose.prisoner.game_server.Scoreboard(listOf(titForTat1, titForTat2))
//        val match = com.mattbobambrose.prisoner.game_server.Match(titForTat1, titForTat2, scoreboard, rules)
//        match.runMatch()
